...
require_relative 'lib/chroma_wave/version'

Gem::Specification.new do |spec|
  spec.name = 'chroma_wave'
  spec.version = ChromaWave::VERSION
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/jtp184/chroma_wave'
